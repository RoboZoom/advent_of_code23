defmodule TwentyFive.Day3 do
  ...
  defp fetch_data(test) when test == false, do: File.read!("assets/2025/d03/compute_input.txt")
  defp fetch_data(test) when test == true, do: File.read!("assets/2025/d03/test_input.txt")
end
